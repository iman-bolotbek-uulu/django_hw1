from polls.models import Item,Purchase
from django.utils import timezone

phone = Item.objects.create(name='Phone',price=10000)
earphone = Item.objects.create(name='Earphone',price=100)
headphone = Item.objects.create(name='Headphone',price=1000)
laptop = Item.objects.create(name='Laptop',price=100000)
tablet = Item.objects.create(name='Tablet',price=10000)
charger = Item.objects.create(name='Charger',price=5000)
watch = Item.objects.create(name='Watch',price=15000)
glasses = Item.objects.create(name='Glasses',price=6000)
column = Item.objects.create(name='Column',price=50000)
case = Item.objects.create(name='Case',price=200)
